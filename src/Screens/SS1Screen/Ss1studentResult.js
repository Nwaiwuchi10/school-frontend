  ...
  return (
    ...
    >
      <div>
        ...
        <Row>
          <Col>
            Option: <strong>{product.option}</strong>
          </Col>
        </Row>
        <Row>
          <Col>
...
export default Ss1studentResult;
